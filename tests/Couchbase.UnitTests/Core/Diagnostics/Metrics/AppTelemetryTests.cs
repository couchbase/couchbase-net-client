...
public class AppTelemetryTests
{
    ...
    public void Test_Counter_Increment_Only()
    {
        ...
        MetricTracker.AppTelemetry.TrackOperation(TimeSpan.FromMilliseconds(150), node, alternateNode, nodeUuid, AppTelemetryServiceType.Query, AppTelemetryCounterType.TimedOut, AppTelemetryRequestType.Query);
        MetricTracker.AppTelemetry.TrackOperation(TimeSpan.FromMilliseconds(150), node, alternateNode, nodeUuid, AppTelemetryServiceType.Query, AppTelemetryCounterType.TimedOut, AppTelemetryRequestType.Query);
        MetricTracker.AppTelemetry.TrackOperation(TimeSpan.FromMilliseconds(150), node, alternateNode, nodeUuid, AppTelemetryServiceType.Query, AppTelemetryCounterType.TimedOut, AppTelemetryRequestType.Query);
    ...
    public void Test_Histogram_And_Counter_Export()
    {
        ...
        MetricTracker.AppTelemetry.TrackOperation(TimeSpan.FromMilliseconds(1), node, alternateNode, nodeUuid, AppTelemetryServiceType.KeyValue, AppTelemetryCounterType.Total, AppTelemetryRequestType.KvRetrieval, bucket);
        MetricTracker.AppTelemetry.TrackOperation(TimeSpan.FromMilliseconds(5), node, alternateNode, nodeUuid, AppTelemetryServiceType.KeyValue, AppTelemetryCounterType.Total, AppTelemetryRequestType.KvRetrieval, bucket);
        MetricTracker.AppTelemetry.TrackOperation(TimeSpan.FromMilliseconds(50), node, alternateNode, nodeUuid, AppTelemetryServiceType.KeyValue, AppTelemetryCounterType.Total, AppTelemetryRequestType.KvRetrieval, bucket);
        MetricTracker.AppTelemetry.TrackOperation(TimeSpan.FromMilliseconds(3_000), node, alternateNode, nodeUuid, AppTelemetryServiceType.KeyValue, AppTelemetryCounterType.Total, AppTelemetryRequestType.KvRetrieval, bucket);

        MetricTracker.AppTelemetry.TrackOperation(TimeSpan.FromMilliseconds(150), node, alternateNode, nodeUuid, AppTelemetryServiceType.Query, AppTelemetryCounterType.Total, AppTelemetryRequestType.Query);
        MetricTracker.AppTelemetry.TrackOperation(TimeSpan.FromMilliseconds(5000), node, alternateNode, nodeUuid, AppTelemetryServiceType.Query, AppTelemetryCounterType.Total, AppTelemetryRequestType.Query);
        MetricTracker.AppTelemetry.TrackOperation(TimeSpan.FromMilliseconds(20000), node, alternateNode, nodeUuid, AppTelemetryServiceType.Query, AppTelemetryCounterType.Total, AppTelemetryRequestType.Query);

        MetricTracker.AppTelemetry.TrackOperation(TimeSpan.FromMilliseconds(3_000), node, alternateNode, nodeUuid, AppTelemetryServiceType.KeyValue, AppTelemetryCounterType.TimedOut, AppTelemetryRequestType.KvRetrieval, bucket);
        MetricTracker.AppTelemetry.TrackOperation(TimeSpan.FromMilliseconds(3_000), node, alternateNode, nodeUuid, AppTelemetryServiceType.KeyValue, AppTelemetryCounterType.TimedOut, AppTelemetryRequestType.KvRetrieval, bucket);
        MetricTracker.AppTelemetry.TrackOperation(TimeSpan.FromMilliseconds(3_000), node, alternateNode, nodeUuid, AppTelemetryServiceType.KeyValue, AppTelemetryCounterType.Canceled, AppTelemetryRequestType.KvRetrieval, bucket);
        ...
        Assert.Contains($"sdk_kv_retrieval_duration_milliseconds_sum{{agent=\"{agent}\",bucket=\"travel-sample\",node=\"node1.example.com\",node_uuid=\"abc123\"}} 3056", result);
        ...
        Assert.Contains($"sdk_query_duration_milliseconds_sum{{agent=\"{agent}\",node=\"node1.example.com\",node_uuid=\"abc123\"}} 25150", result);
    ...
    public void Test_Service_Metrics_Export()
    {
        ...
        MetricTracker.AppTelemetry.TrackOperation(TimeSpan.FromMilliseconds(50), node, alternateNode, nodeUuid, AppTelemetryServiceType.Query, AppTelemetryCounterType.Total, AppTelemetryRequestType.Query);
        MetricTracker.AppTelemetry.TrackOperation(TimeSpan.FromMilliseconds(500), node, alternateNode, nodeUuid, AppTelemetryServiceType.Query, AppTelemetryCounterType.Total, AppTelemetryRequestType.Query);
        MetricTracker.AppTelemetry.TrackOperation(TimeSpan.FromMilliseconds(15000), node, alternateNode, nodeUuid, AppTelemetryServiceType.Query, AppTelemetryCounterType.Total, AppTelemetryRequestType.Query);

        MetricTracker.AppTelemetry.TrackOperation(TimeSpan.FromMilliseconds(200), node, alternateNode, nodeUuid, AppTelemetryServiceType.Analytics, AppTelemetryCounterType.Total, AppTelemetryRequestType.Analytics);
        MetricTracker.AppTelemetry.TrackOperation(TimeSpan.FromMilliseconds(25000), node, alternateNode, nodeUuid, AppTelemetryServiceType.Analytics, AppTelemetryCounterType.Total, AppTelemetryRequestType.Analytics);

        MetricTracker.AppTelemetry.TrackOperation(TimeSpan.FromMilliseconds(10_000), node, alternateNode, nodeUuid, AppTelemetryServiceType.Query, AppTelemetryCounterType.TimedOut, AppTelemetryRequestType.Query);
        MetricTracker.AppTelemetry.TrackOperation(TimeSpan.FromMilliseconds(10_000), node, alternateNode, nodeUuid, AppTelemetryServiceType.Analytics, AppTelemetryCounterType.Canceled, AppTelemetryRequestType.Analytics);
        MetricTracker.AppTelemetry.TrackOperation(TimeSpan.FromMilliseconds(10_000), node, alternateNode, nodeUuid, AppTelemetryServiceType.Analytics, AppTelemetryCounterType.Total, AppTelemetryRequestType.Analytics);
        ...
        Assert.DoesNotContain($"sdk_query_r_canceled", result);
        Assert.Contains($"sdk_query_r_total{{agent=\"{agent}\",node=\"node1.example.com\",node_uuid=\"abc123\"}} 4", result);
        Assert.DoesNotContain($"sdk_analytics_r_timedout", result);
        ...
        Assert.Contains($"sdk_query_duration_milliseconds_bucket{{le=\"75000\",agent=\"{agent}\",node=\"node1.example.com\",node_uuid=\"abc123\"}} 3", result);
        Assert.Contains($"sdk_query_duration_milliseconds_bucket{{le=\"+Inf\",agent=\"{agent}\",node=\"node1.example.com\",node_uuid=\"abc123\"}} 3", result);
        Assert.Contains($"sdk_query_duration_milliseconds_sum{{agent=\"{agent}\",node=\"node1.example.com\",node_uuid=\"abc123\"}} 15550", result);
        Assert.Contains($"sdk_query_duration_milliseconds_count{{agent=\"{agent}\",node=\"node1.example.com\",node_uuid=\"abc123\"}} 3", result);
        ...
        Assert.Contains($"sdk_analytics_duration_milliseconds_sum{{agent=\"{agent}\",node=\"node1.example.com\",node_uuid=\"abc123\"}} 35200", result);
    ...
    public void When_Disabled_Should_Not_Collect_Metrics()
    {
        ...
        MetricTracker.AppTelemetry.TrackOperation(TimeSpan.FromMilliseconds(50), node, alternateNode, nodeUuid, AppTelemetryServiceType.KeyValue, AppTelemetryCounterType.Total, AppTelemetryRequestType.KvRetrieval);
        MetricTracker.AppTelemetry.TrackOperation(TimeSpan.FromMilliseconds(50), node, alternateNode, nodeUuid, AppTelemetryServiceType.KeyValue, AppTelemetryCounterType.TimedOut, AppTelemetryRequestType.KvRetrieval);
    ...
    public void IncrementMetrics_Should_Update_Both_Histogram_And_Counter()
    {
        ...
        MetricTracker.AppTelemetry.TrackOperation(TimeSpan.FromMilliseconds(50),
            node,
            alternateNode,
    ...
    public void Operations_Should_Be_Placed_In_Correct_Duration_Buckets()
    {
        ...
        MetricTracker.AppTelemetry.TrackOperation(TimeSpan.FromMilliseconds(1), node, alternateNode, nodeUuid, AppTelemetryServiceType.KeyValue, AppTelemetryCounterType.Total, AppTelemetryRequestType.KvRetrieval, bucket);
        MetricTracker.AppTelemetry.TrackOperation(TimeSpan.FromMilliseconds(2), node, alternateNode, nodeUuid, AppTelemetryServiceType.KeyValue, AppTelemetryCounterType.Total, AppTelemetryRequestType.KvRetrieval, bucket);
        MetricTracker.AppTelemetry.TrackOperation(TimeSpan.FromMilliseconds(50), node, alternateNode, nodeUuid, AppTelemetryServiceType.KeyValue, AppTelemetryCounterType.Total, AppTelemetryRequestType.KvRetrieval, bucket);
        MetricTracker.AppTelemetry.TrackOperation(TimeSpan.FromMilliseconds(400), node, alternateNode, nodeUuid, AppTelemetryServiceType.KeyValue, AppTelemetryCounterType.Total, AppTelemetryRequestType.KvRetrieval, bucket);
        MetricTracker.AppTelemetry.TrackOperation(TimeSpan.FromMilliseconds(800), node, alternateNode, nodeUuid, AppTelemetryServiceType.KeyValue, AppTelemetryCounterType.Total, AppTelemetryRequestType.KvRetrieval, bucket);
        MetricTracker.AppTelemetry.TrackOperation(TimeSpan.FromMilliseconds(2_000), node, alternateNode, nodeUuid, AppTelemetryServiceType.KeyValue, AppTelemetryCounterType.Total, AppTelemetryRequestType.KvRetrieval, bucket);
        MetricTracker.AppTelemetry.TrackOperation(TimeSpan.FromMilliseconds(3_000), node, alternateNode, nodeUuid, AppTelemetryServiceType.KeyValue, AppTelemetryCounterType.Total, AppTelemetryRequestType.KvRetrieval, bucket);
        ...
        Assert.Contains($"sdk_kv_retrieval_duration_milliseconds_sum{{agent=\"{agent}\",bucket=\"default\",node=\"node1.example.com\",node_uuid=\"abc123\"}} 6253", result);
    }
}
