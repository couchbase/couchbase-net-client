...
namespace Couchbase.UnitTests.Core.IO.Authentication.X509
{
    public class RotatingCertificateFactoryTests
    {
        ...
        private readonly Mock<ILogger<IRotatingCertificateFactory>> _mockLogger;
        ...
        public RotatingCertificateFactoryTests(ITestOutputHelper testOutputHelper)
        {
            _testOutputHelper = testOutputHelper;
            _mockCertificateFactory = new Mock<ICertificateFactory>();

            //_loggerFactory = new Mock<ILoggerFactory>();
            _mockLogger = new Mock<ILogger<IRotatingCertificateFactory>>();

            /*_mockLoggerFactory = new Mock<ILoggerFactory>();
            _mockLoggerFactory.Setup(x => x.CreateLogger<IRotatingCertificateFactory>())
        ...
        private static X509Certificate2Collection GetExpiredCertificates()
        {
            ...
            var expiredCertificate = new X509Certificate2(certificateBytes);
