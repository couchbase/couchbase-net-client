...
{
	[MemoryDiagnoser]
    public class LoggingMeterRecordValueWithTag
    {
        ...
        {
            var recorder = _meter.ValueRecorder(OuterRequestSpans.ServiceSpan.Kv.Name);
            recorder.RecordValue(_i++ >>> 10,
                new KeyValuePair<string, string>(OuterRequestSpans.Attributes.Operation, OuterRequestSpans.ServiceSpan.Kv.SetUpsert));
        }
    }
}
