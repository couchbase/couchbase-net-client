...
{
    [TestFixture]
    public class SubArrayPushFirstTests
    {
        [Test]
        public void When_Cloned_Expires_Is_Copied()
        {
            ...
            var op = new SubArrayPushFirst<dynamic>(builder, "key", null, new DefaultTranscoder(), 0)
            {
                Expires = 10
            };

            Assert.AreEqual(10, op.Expires);
            var cloned = op.Clone() as SubArrayPushFirst<dynamic>;
