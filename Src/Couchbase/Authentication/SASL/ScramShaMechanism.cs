...
namespace Couchbase.Authentication.SASL
{
    ...
    internal class ScramShaMechanism : ISaslMechanism
    {
        ...
        public bool Authenticate(IConnection connection, string username, string password)
        {
            ...
            Log.DebugFormat("Client First Message: {0}", ClientFirstMessage);
            ...
            {
                Log.DebugFormat("Server First Message: {0}", serverFirstResult.Message);
                ...
                Log.DebugFormat("Client Final Message: {0}", ClientFinalMessage);
                ...
                Log.DebugFormat("Server Final Message: {0}", serverFinalResult.Message);
