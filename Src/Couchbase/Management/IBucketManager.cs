...
namespace Couchbase.Management
{
    ...
    public interface IBucketManager
    {
        ...
        Task<IResult> InsertDesignDocument(string designDocName, string designDoc);
        ...
        /// <param name="designDoc">A design document JSON string.</param>
        /// <returns>A boolean value indicating the result.</returns>
        Task<IResult> UpdateDesignDocument(string designDocName, string designDoc);
        ...
        Task<IResult<string>> GetDesignDocument(string designDocName);
        ...
        /// <param name="designDocName">The name of the design document.</param>
        /// <returns>A boolean value indicating the result.</returns>
        Task<IResult> RemoveDesignDocument(string designDocName);
        ...
        Task<IResult<string>> GetDesignDocuments(bool includeDevelopment = false);
