...
namespace Couchbase.Search
{
    ...
    /// </summary>
    /// <seealso cref="Couchbase.Search.ISearchParams" />
    public class SearchParams : ISearchParams
    {
        ...
        /// <returns></returns>
        public ISearchParams Limit(int limit)
        {
            _limit = limit;
            return this;
        }
        ...
        /// <returns></returns>
        public ISearchParams Skip(int skip)
        {
            _skip = skip;
            return this;
        }
        ...
        /// <returns></returns>
        public ISearchParams Explain(bool explain)
        {
            _explain = explain;
            return this;
        }
        ...
        /// <returns></returns>
        public ISearchParams Facets(params ISearchFacet[] searchFacets)
        {
            if (_facets == null)
            {
        ...
        /// <returns></returns>
        public ISearchParams Timeout(TimeSpan timeout)
        {
            _timeOut = timeout;
            return this;
        }
