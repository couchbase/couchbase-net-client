...
namespace Couchbase
{
    ...
    #region Spatial View Options

    public class SpatialViewOptions
    {
        public StaleState StaleState { get; set; }
        public int Skip { get; set; }
        public int Limit { get; set; }
        public IList<double?> StartRange { get; set; }
        public IList<double?> EndRange { get; set; }
        public bool Development { get; set; }
        public bool FullSet { get; set; }
        public int ConnectionTimeout { get; set; }
        ...
        public SpatialViewOptions WithSkip(int skip)
        {
            Skip = skip;
            return this;
        }

        public SpatialViewOptions WithLimit(int limit)
        {
            Limit = limit;
            return this;
        }

        public SpatialViewOptions WithStartRange(IList<double?> startRange)
        {
            StartRange = startRange;
            return this;
        }

        public SpatialViewOptions WithEndRange(IList<double?> endRange)
        {
            EndRange = endRange;
            return this;
        }

        public SpatialViewOptions WithDevelopment(bool development)
        {
            Development = development;
            return this;
        }

        public SpatialViewOptions WithFullSet(bool fullSet)
        {
            FullSet = fullSet;
            return this;
        }

        public SpatialViewOptions WithConnectionTimeout(int connectionTimeout)
        {
            ConnectionTimeout = connectionTimeout;
            return this;
        }
