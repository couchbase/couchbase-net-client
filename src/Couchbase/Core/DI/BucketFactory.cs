...
namespace Couchbase.Core.DI
{
    ...
    internal class BucketFactory : IBucketFactory
    {
        ...
        public BucketBase Create(string name, BucketType bucketType) =>
            bucketType switch
            {
                BucketType.Couchbase => new CouchbaseBucket(name, _clusterContext, _scopeFactory, _retryOrchestrator, _couchbaseLogger),
                BucketType.Ephemeral => new CouchbaseBucket(name, _clusterContext, _scopeFactory, _retryOrchestrator, _couchbaseLogger),
                BucketType.Memcached => new MemcachedBucket(name, _clusterContext, _scopeFactory, _retryOrchestrator, _memcachedLogger),
