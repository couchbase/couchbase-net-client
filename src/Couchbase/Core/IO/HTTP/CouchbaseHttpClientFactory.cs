...
namespace Couchbase.Core.IO.HTTP
{
    ...
    internal sealed class CouchbaseHttpClientFactory : ICouchbaseHttpClientFactory
    {
        ...
        public CouchbaseHttpClientFactory(ClusterContext context, ILogger<CouchbaseHttpClientFactory> logger, TypedRedactor redactor, ICertificateValidationCallbackFactory callbackFactory)
        {
