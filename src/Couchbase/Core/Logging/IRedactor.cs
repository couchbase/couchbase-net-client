...
namespace Couchbase.Core.Logging
{
    ...
    /// boxes the result and, for value-type arguments, the argument before any log level is consulted.
    /// Consequently, registering an implementation of <see cref="IRedactor"/> as a cluster service does
    /// not change how the SDK redacts — the registration is discarded and a warning is logged. Use
