...
namespace Couchbase.Management.Eventing
{
    ...
    public class EventingFunction
    {
        ...
        public string ToJson()
        {
            ...
            {
                new JProperty("depcfg", DeploymentConfig.ToJson()),
                new JProperty("settings", Settings.ToJson()),
                new JProperty("version", Version),
                new JProperty("appname", Name),
                new JProperty("appcode", Code)
            };
    ...
    public class DeploymentConfig
    {
        ...
        /// </summary>
        /// <remarks>The min length is 1 and the max is 30.</remarks>
        [JsonProperty("metadata_collection")]
        ...
        internal JObject ToJson()
        {
            var root = new JObject
            {
                new JProperty("buckets", BucketBindings.Select(x=>x.ToJson())),
                new JProperty("curl", UrlBindings.Select(x=>x.ToJson())),
                new JProperty("constants", ConstantBindings.Select(x=>x.ToJson())),
                new JProperty("source_bucket", SourceBucket),
                new JProperty("source_scope", SourceScope),
                new JProperty("source_collection", SourceCollection),
                new JProperty("metadata_bucket", MetadataBucket),
                new JProperty("metadata_scope", MetadataScope),
                new JProperty("metadata_collection", MetadataCollection),
            };
    ...
    public class EventingFunctionBucketBinding
    {
        ...
        internal JObject ToJson()
        {
            var root = new JObject
            {
                ...
                new JProperty("bucket_name", BucketName),
                new JProperty("scope_name", ScopeName),
                new JProperty("collection_name", CollectionName),
                new JProperty("access", Access.GetDescription())
            };
    ...
    public class EventingFunctionUrlBinding
    {
        ...
        /// </summary>
        /// <remarks>Required.</remarks>
        [JsonProperty("validate_ssl_certificate")]
        ...
        {
            var root = new JObject(Auth.ToJson())
            {
                new JProperty("hostname", Hostname),
                new JProperty("allow_cookies", Hostname),
                new JProperty("validate_ssl_certificate", Hostname),
                new JProperty("value", Alias)
            };
    ...
    {
        List<JProperty> ToJson();
    }

    /// <summary>
    /// Do not use authentication.
    /// </summary>
    public class EventingFunctionUrlNoAuth : IEventingFunctionUrlAuth
    {
        public List<JProperty> ToJson()
        {
            return new()
            {
                new JProperty("auth_type", "no-auth")
            };
        }
    }
    ...
    /// </summary>
    public class EventingFunctionUrlAuthDigest : IEventingFunctionUrlAuth
    {
        /// <summary>
        /// The username for http auth methods that use it.
        /// </summary>
        ...
        public List<JProperty> ToJson()
        {
            return new()
            {
                new JProperty("password", Password),
                new JProperty("username", Username),
                new JProperty("auth_type", "digest")
            };
        }
    }
    ...
    public class EventingFunctionUrlAuthBearer : IEventingFunctionUrlAuth
    {
        ...
        public List<JProperty> ToJson()
        {
            return new()
            {
                new JProperty("bearer_key", Key),
                new JProperty("auth_type", "bearer")
            };
        }
    }
    ...
    public class EventingFunctionSettings
    {
        ...
        [JsonProperty("cpp_worker_thread_count")]
        ...
        /// </summary>
        [JsonProperty("dcp_stream_boundary")]
        ...
        [JsonProperty("language_compatibility")]
        ...
        [JsonProperty("lcb_inst_capacity")]
        ...
        [JsonProperty("num_timer_partitions")]
        ...
        [JsonProperty("timer_context_size")]
        ...
        [JsonProperty("bucket_cache_size")]
        ...
        [JsonProperty("curl_max_allowed_resp_size")]
        ...
        /// </summary>
        /// <remarks>The minimum is 1 and the default is 10.</remarks>
        [JsonProperty("app_log_max_files")]
        ...
        internal JObject ToJson()
        {
            ...
            {
                //supported by UI
                new JProperty("worker_count", WorkerCount),
                new JProperty("execution_timeout", ExecutionTimeout.TotalMilliseconds),
                new JProperty("user_prefix", UserPrefix),
                new JProperty("n1ql_consistency", QueryConsistency.GetDescription()),
                new JProperty("timer_context_size", 1024),
                new JProperty("dcp_stream_boundary", DcpStreamBoundary.GetDescription()),
                new JProperty("log_level", LogLevel.GetDescription()),
                new JProperty("language_compatibility", LanguageCompatibility.GetDescription()),
                new JProperty("processing_status", ProcessingStatus == EventingFunctionProcessingStatus.Running),
                new JProperty("deployment_status", DeploymentStatus == EventingFunctionDeploymentStatus.Deployed),
