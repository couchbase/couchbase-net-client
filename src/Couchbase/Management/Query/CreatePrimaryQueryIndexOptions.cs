...
namespace Couchbase.Management.Query
{
    public class CreatePrimaryQueryIndexOptions
    {
        ...
        {
            this.Deconstruct(out string? indexNameValue,
                out bool ignoreIfExistsValue,
                out bool deferredValue,
                out CancellationToken tokenValue,
                out string? scopeNameValue,
                out string? collectionNameValue,
                out string? queryContext,
                out TimeSpan timeoutValue);
            return new ReadOnly(indexNameValue,
                ignoreIfExistsValue,
                deferredValue, tokenValue,
                scopeNameValue,
                collectionNameValue,
                queryContext,
                timeoutValue);
